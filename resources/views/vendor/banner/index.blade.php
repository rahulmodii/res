        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
                ...
                @else
                    <a href="{{route('restaurant.banner.create')}}" class="btn btn-primary">{{__('Add New Banner')}}</a>
                @endif
            </div>
            <!-- /.card-header -->
            <div class="card-body row">
              <table id="" class="table table-bordered table-striped table-responsive">
                ...
                <tr>
                  <td>{{$key+1}}</td>
                  <td><img src="{{asset('uploads/restaurant/banner')}}/{{$banner->image}}" width="210"></td>
                  ...
                  <td>
                    <div class="input-group-prepend">
                        ...
                        <ul class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 48px, 0px);">
                          <li class="dropdown-item"><a href="{{route('restaurant.banner.edit',encrypt($banner->id))}}">{{__('Edit Banner')}}</a></li>
                          <li class="dropdown-item"><a onclick="confirm_modal('{{route('restaurant.banner.delete',encrypt($banner->id))}}')">{{__('Delete Banner')}}</a></li>
                        </ul>
                    </div>
                  </td>
                </tr>
