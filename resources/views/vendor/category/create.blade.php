        ...
        <div class="col-md-12">
          <div class="card card-primary">
              <div class="card-header">
                ...
                @else
                  <h3 class="card-title">{{__('Category Info')}}</h3>
                @endif
              </div>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="{{route('restaurant.category.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      @enderror
                      <input type="number" min="1" class="form-control @error('position') is-invalid @enderror" name="position">
                    </div>
                  </div>
                <!-- /.card-body -->
