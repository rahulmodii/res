        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
                ...
                @else
                    <a href="{{route('restaurant.category.create')}}" class="btn btn-primary">{{__('Add New Category')}}</a>
                @endif
            </div>
            <!-- /.card-header -->
                  ...
                  <td>
                    <div class="input-group-prepend">
                        ...
                        <ul class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 48px, 0px);">
                             ...
                             <li class="dropdown-item"><a href="{{route('restaurant.menu.edit',encrypt($category->id))}}">{{__('Edit Category')}}</a></li>
                             <li class="dropdown-item"><a onclick="confirm_modal('{{route('restaurant.menu.delete',encrypt($category->id))}}')">{{__('Delete Category')}}</a></li>
